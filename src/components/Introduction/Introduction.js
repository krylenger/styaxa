...
const Introduction = () => {
    return(
        <div className='introduction-container'>
            <div className='introduction-container-internal introduction-container-internal-1'>
                I am Photographer
            </div>
            <div className='introduction-container-internal introduction-container-internal-2'>
                Aleksei Stiazhkin
            </div>
            <div className='introduction-container-internal introduction-container-internal-3'>
